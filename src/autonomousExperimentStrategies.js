...
export const STRATEGIES_BY_GAP_TYPE = {
  ...
  field_interaction: [
    {
      strategyId: 'focus_type_validate_field',
      type: 'visual_ui',
      title: 'Focar campo, digitar texto e validar valor',
      capability: 'field.interaction',
      priority: 1,
      environment: 'real_vm',
      actions: [
        { kind: 'click', target: 'text_field' },
        { kind: 'type_text', textTemplate: '{{text}}' },
      ],
      validationSignals: ['field_focused', 'field_value_changed'],
