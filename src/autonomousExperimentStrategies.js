...
export const STRATEGIES_BY_GAP_TYPE = {
  ...
  text_input: [
    {
      strategyId: 'vm_notepad_text_input',
      type: 'native_command',
      title: 'Abrir campo controlado no Notepad, digitar e validar valor',
  ...
  file_management: [
    {
      strategyId: 'vm_open_file_explorer_safe_folder',
      type: 'native_command',
      title: 'Abrir Explorador de Arquivos em pasta temporaria controlada',
      capability: 'file.explorer.open',
      priority: 1,
      environment: 'real_vm',
      actions: [{ kind: 'run_command', command: 'open_file_explorer_safe_folder' }],
      validationSignals: ['folder_exists', 'explorer_window_detected'],
      fallbackStrategyId: 'vm_create_controlled_folder_file',
    },
    {
      strategyId: 'vm_create_controlled_folder_file',
      type: 'native_command',
      title: 'Criar pasta e arquivo temporarios e validar existencia',
      capability: 'file.folder.create',
      priority: 2,
      environment: 'real_vm',
      actions: [{ kind: 'run_command', command: 'create_controlled_folder_file' }],
      validationSignals: ['folder_exists', 'file_exists', 'explorer_window_detected'],
    },
  ],
  app_install: [
    {
      strategyId: 'vm_validate_safe_installer_flow',
      type: 'native_command',
      title: 'Validar descoberta segura de pacote instalavel na VM',
      capability: 'app.install.safe_probe',
      priority: 1,
      environment: 'real_vm',
      actions: [{ kind: 'run_command', command: 'validate_safe_installer_flow' }],
      validationSignals: ['package_manager_available', 'package_search_result'],
    },
  ],
  field_interaction: [
    {
